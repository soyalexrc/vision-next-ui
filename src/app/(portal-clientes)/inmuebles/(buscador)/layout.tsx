        ...
        <div  className={`min-h-screen`}>
            <section className="relative">
                ...
                <div
                    ...
                    <p className="text-white text-sm lg:text-xl text-center">
                        Consulta nuestra amplia oferta de propiedades en venta y alquiler. Encuentra la opcion
                        que <br/> mejor se adapte a tus
                        necesidades
                    </p>
                </div>
            </section>
            ...
            <section className="lg:px-20 grid gap-4 lg:grid-cols-12 ">
                ...
                <div className="order-1 lg:col-span-9 my-5 lg:order-2">
                    ...
                    <div className={`gap-4 grid-cols-1 lg:grid-cols-2 `}>
                        {children}
                    </div>
    ...
    return (
        <div className="flex justify-between items-center px-4 mb-4">
            ...
            <div className="lg:hidden">
                <Button variant="ghost" onClick={() => setShowFilters(true)} className="bg-red-900"
                        aria-label="Like">
            ...
            <div className="gap-4 hidden lg:flex">
                ...
                >
                    <List height={30} width={30}
                          className={`hover:text-white ${viewStyle === 'list' ? 'text-white' : 'text-gray-600'}`}/>
                </Button>
            </div>
