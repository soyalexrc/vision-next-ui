  ...
  return (
    <section className="my-14 lg:px-24 w-full">
      ...
      <div className="py-4 px-4 lg:px-0 lg:grid grid-cols-4 gap-2">
        <div>
          <Select size="sm" label="Inmueble" className="lg:max-w-xs mb-4">
            {animals.map((animal) => (
          ...
          <Select size="sm" label="Precio" className="mb-4 lg:mb-0 lg:max-w-xs">
            {animals.map((animal) => (
              <SelectItem key={animal.value} value={animal.value}>
                {animal.label}
              </SelectItem>
        ...
        <div>
          ...
          <Select size="sm" label="Referencia" className="mb-4 lg:mb-0 lg:max-w-xs">
            {animals.map((animal) => (
              <SelectItem key={animal.value} value={animal.value}>
                {animal.label}
              </SelectItem>
        ...
        <div>
          ...
          <Select size="sm" label="Otras opciones" className="mb-4 lg:max-w-xs lg:mb-0">
            {animals.map((animal) => (
              <SelectItem key={animal.value} value={animal.value}>
                {animal.label}
              </SelectItem>
