            ...
            <div className='lg:grid gap-4 grid-cols-12 px-5'>
                ...
                <div className='col-span-6 lg:px-20 '>
                    <Image
                        ...
                        src='/vision-logo.png'
                    />
                    <p>Grupo Induo, es una empresa de intermediación inmobiliaria y gestión de activos, compuesta por
                        profesionales con más de veinte años de experiencia en el sector.
                        Actualmente gestionamos el patrimonio inmobiliario de particulares, entidades financieras y
                        fondos de inversión, ya sea residencial, comercial y terciario. También realizamos operaciones
                        de Sale & Lease back. <br/>
                        ...
                        nuestros clientes el tipo de activo que más se ajuste a sus intereses.
                        Ofrecemos nuestros servicios tanto a particulares, empresas y fondos de inversión, adecuando
                        cada tipo de operación a las preferencias y capacidad de cada uno.</p>
                </div>
                ...
                <div className='col-span-3'>
                    ...
                    <Link href='https://www.tiktok.com/@somosvisioninmobiliaria' target='_blank'
                          className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover' color='foreground'>
                        <TiktokIcon width={30} height={30} fill='rgb(97, 3, 33)'/>
                        <small className='font-bold text-inherit'>@somosvisioninmobiliaria</small>
                    </Link>
                    <Link href='https://www.instagram.com/somosvisioninmobiliaria/' target='_blank'
                          className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover' color='foreground'>
                        <InstagramIcon width={30} height={30} fill='rgb(97, 3, 33)'/>
                        <small className='font-bold text-inherit'>@somosvisioninmobiliaria</small>
                    </Link>
                    <Link href='https://www.facebook.com/Somosvisioninmobiliaria/' target='_blank'
                          className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover' color='foreground'>
                        <FacebookIcon width={30} height={30} fill='rgb(97, 3, 33)'/>
                        <small className='font-bold text-inherit'>@Somosvisioninmobiliaria</small>
                    </Link>
                    <Link href='https://wa.me/584244095149' target='_blank'
                          className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover' color='foreground'>
                        <WhatsappIcon width={30} height={30} fill='rgb(97, 3, 33)'/>
                        <small className='font-bold text-inherit'>(0424) - 409 51 49</small>
                    </Link>
                    <Link href='mailto:ventas@visioninmobiliaria.com.ve' target='_blank'
                          className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover' color='foreground'>
                    ...
                    <Link
                        ...
                        target='_blank' className='mb-3 flex gap-2 items-center cursor-pointer' underline='hover'
                        color='foreground'>
