    ...
    const itemsMenu = [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    title: 'En alquiler',
                    path: '/inmuebles?tipo_de_operacion=Alquiler&pagina=1&limite=10',
                },
                {
                ...
                {
                    title: 'Estadias residenciales (temporadas largas)',
        ...
        >
            <NavbarContent className="sm:hidden" justify="start">
                ...
                <NavbarBrand className="justify-end">
                    <NextLink href="/">
                        <Image title="Vision inmobiliaria logo" alt="Vision inmobiliaria logo" src="/vision-icon.png"
                               width={50} height={50}/>
                    </NextLink>
                </NavbarBrand>
            </NavbarContent>
                ...
                {itemsMenu.map((item, index) => (
                    <NavbarMenuItem key={`${item.id}-${index}`}>
                        ...
                        {item.children.length < 1 && (
                            <Link className="w-full pl-4 text-xl mb-2" href={item.path} as={NextLink} size="lg"
                                  onClick={toggleMenu}>
                                {item.title}
                            </Link>
                        )}
