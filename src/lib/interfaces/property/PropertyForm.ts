...
export const PropertyFormSchema = z.object({
  ...
  negotiationInformation: z.object({
    ...
    realstateadvisername: z.string().optional().nullable(),
    allyname: z.string().optional().nullable(),
    externaladvisername: z.string().optional().nullable(),
    ...
    additional_price: z.string().optional().nullable(),
