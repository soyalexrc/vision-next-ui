        ...
        <>
            <section className='relative'>
                ...
                <div
                    ...
                    <p className='text-white text-sm lg:text-xl text-center'>Es nuestro trabajo el proporcionarte el tipo de inmueble que
                        más se ajuste a sus intereses</p>
                </div>
            </section>
            <section className=' my-5 px-4 lg:px-24 grid gap-4 grid-cols-1 lg:grid-cols-12'>
                <div className='order-2 lg:order-1 lg:col-span-3'>
                    ...
                    <p className='text-sm text-center'>Si deseas más información sobre esta propiedad, por favor, rellena el
                        formulario.</p>
