            ...
            <section className='lg:px-24 my-10'>
                ...
                <div className='grid  grid-cols-1 lg:grid-cols-2 gap-4'>
                    <div className=' border-r-1 px-4'>
                        ...
                        <p>Av Feo La Cruz, Local Mezz-6, Nivel Mezzanina, CC Paseo La Granja Urbanización Las Quintas,
                            Naguanagua 2005, Carabobo, Venezuela</p>
                    ...
                    <div className='px-4'>
                        ...
                        <div className='grid gap-4 grid-cols-2 my-5'>
                            <Select size='sm'  label="Tipo de inmueble">
                                {animals.map((animal) => (
                            ...
                            <Select size='sm'  label="Tipo de operacion">
                                {animals.map((animal) => (
                                    <SelectItem key={animal.value} value={animal.value}>
                                        {animal.label}
                                    </SelectItem>
                        ...
                        <Input size='sm'  type="text" label="Precio maximo"/>

                        <div className='grid gap-4 grid-cols-2 my-5'>
                            <Input size='sm'  type="text" label="Poblacion"/>
                            <Input size='sm'  type="text" label="Zona"/>
                        </div>
                        ...
                        <div className='my-5'>
                            ...
                            <span className='text-sm'>He leido y acepto los <Link underline='always' as={NextLink} href='/'>terminos y condiciones</Link></span>
                        </div>
